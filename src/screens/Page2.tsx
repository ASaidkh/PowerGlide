  ...
  const processVoiceCommand = (text: string) => {
    ...
    for (const [key, value] of Object.entries(commandMappings)) {
      if (command.includes(key)) {
        ...
        console.log(`Voice command recognized: "${key}"`);
        console.log(`Bluetooth packet sent -> x: ${value.x}, y: ${value.y}`);
        console.log(`Voice command processing time: ${endTime - startTime} ms`);
        break;
      }
    }
  };
